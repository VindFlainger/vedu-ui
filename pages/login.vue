            ...
            <div class="px-20 flex flex-col justify-center">
                <div>
                    <div class="flex flex-col items-center">
                        ...
                        <USwitch :items="roles" v-model="role" size="md"/>
                    </div>
                    <div>
                        <LazyActionLoginStudent v-if="action === 'login' && role === 'student'"/>
                    </div>
                </div>
            </div>
        </div>
...
import ActionLoginStudent from "~/components/Login/ActionLoginStudent.vue";
